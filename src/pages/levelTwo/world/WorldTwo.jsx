...
export const WorldTwo = (props) => {
    return (
        <>
            ...
            <ColliderBox position={[29.8, -0.3, -36]} scale={[0.3, 1, 16]} color="blue" />
            <ColliderBox position={[-23.35, -0.3, -36]} scale={[0.3, 1, 16]} color="blue" />
            <ColliderBox position={[-8.75, -0.3, -43.85]} scale={[28.9, 1, 0.3]} color="blue" />
            <ColliderBox position={[19.75, -0.3, -43.85]} scale={[20, 1, 0.3]} color="blue" />
            {
                //Abajo Derecha
            }
            ...
            <ColliderBox position={[1, -0.3, -26.35]} scale={[0.3, 1, 3]} color="blue" />
            <ColliderBox position={[-2.7, -0.3, -25.6]} scale={[7.5, 1, 0.3]} color="blue" />
            <ColliderBox position={[3, -0.3, -33.5]} scale={[0.3, 1, 16.3]} color="green" />
            <ColliderBox position={[1, -0.3, -30.5]} scale={[0.3, 1, 16.3]} color="blue" />
            <ColliderBox position={[-1, -0.3, -35.7]} scale={[0.3, 1, 12]} color="blue" />
            <ColliderBox position={[1, -0.3, -41.6]} scale={[4, 1, 0.3]} color="blue" />
            <ColliderBox position={[-6, -0.3, -29.6]} scale={[10, 1, 0.3]} color="blue" />
            <ColliderBox position={[-17.4, -0.3, -29.6]} scale={[7.9, 1, 0.3]} color="blue" />
            <ColliderBox position={[-10.9, -0.3, -35.5]} scale={[0.3, 1, 12]} color="blue" />
            <ColliderBox position={[-8.5, -0.3, -37.8]} scale={[0.3, 1, 12]} color="blue" />
            <ColliderBox position={[-6.3, -0.3, -35.8]} scale={[0.3, 1, 12]} color="blue" />
            <ColliderBox position={[-3.8, -0.3, -37.8]} scale={[0.3, 1, 12]} color="blue" />
            <ColliderBox position={[-21.3, -0.3, -35.5]} scale={[0.3, 1, 12]} color="blue" />
            <ColliderBox position={[-17.4, -0.3, -41.6]} scale={[7.9, 1, 0.3]} color="blue" />
            <ColliderBox position={[-13.3, -0.3, -36.7]} scale={[0.3, 1, 10]} color="blue" />
            <ColliderBox position={[-16.1, -0.3, -31.6]} scale={[5.9, 1, 0.3]} color="blue" />
            <ColliderBox position={[-19, -0.3, -36.7]} scale={[0.3, 1, 10]} color="blue" />
            <ColliderBox position={[5.8, -0.3, -37.2]} scale={[0.3, 1, 13.6]} color="blue" />
            {
                //Arriba Derecha
            }
            ...
            <ColliderBox position={[9.3, -0.3, -26.35]} scale={[0.3, 1, 3]} color="blue" />
            ...
            <ColliderBox position={[25.8, -0.3, -38.4]} scale={[0.3, 1, 11]} color="blue" />
            <ColliderBox position={[24, -0.3, -37.4]} scale={[0.3, 1, 9]} color="blue" />
            <ColliderBox position={[18, -0.3, -33]} scale={[12, 1, 0.3]} color="blue" />
            <ColliderBox position={[18, -0.3, -35]} scale={[12, 1, 0.3]} color="blue" />
            <ColliderBox position={[18, -0.3, -41.8]} scale={[12, 1, 0.3]} color="blue" />
            <ColliderBox position={[18, -0.3, -39.8]} scale={[12, 1, 0.3]} color="blue" />
            <ColliderBox position={[18, -0.3, -37.8]} scale={[12, 1, 0.3]} color="blue" />

            <Ramp position={[1.9, -1.5, -26.5]} rotation={[0, -4.7, Math.PI / 8]} args={[4, 2, 2]} color={"white"} />
            <Ramp position={[-13.9, -1.5, -9.5]} rotation={[0, -4.7, Math.PI / 8]} args={[4, 2, 2]} color={"green"} />
            <Ramp position={[12.9, -1.5, -7]} rotation={[0, -4.7, Math.PI / 8]} args={[4, 2, 2]} color={"green"} />
        </>
    )
}
